...
if(strcmp(option_1,'Yes'))
    file=fopen('D:\downsampling_processor_fpga\Project Final_Manual\Compiler 3.0\binary.txt');
...
imwrite(im_in,'D:\downsampling_processor_fpga\Project Final_Manual\Processor output\Im_in.png');
clc;
for i=1:iter
    ...
    fclose(instrfind);
    fopen(fpga);
    fpga.Timeout = 30;                  % Timeout period in seconds
...
im_out=uint8(im_out);
imshow(im_out);
imwrite(im_out,'D:\downsampling_processor_fpga\Project Final_Manual\Processor output\Im_out.png');
